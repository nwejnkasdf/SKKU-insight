...
v13 라운드 A4 Topic-driven Pivot prep — A4 가 LLM tool-use 검색 + 신규 ORM 4종 +
alembic 0003 + /topics/{id}/documents cross-cutting 을 도입하므로, auth 인프라
(weak_password 5룰 / username enumeration / logout denylist + refresh revoke /
account-deletion gate) 회귀 가드 두텁게. A4 본문 변경이 이 영역을 깨면 즉시 빨간불.
"""
...
# ============================================================
# v13 라운드 A4 prep — weak_password 정책 5 룰 회귀 가드
# ============================================================
