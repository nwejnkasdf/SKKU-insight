...
| C-급 (인터뷰 식별 + codex review v1·v2 + multi-worker + rotation 옵션 B) | 29 (해결 29 — C-2 부분 해소, C-6~29 신규 해결 A2) | (없음) | A2 (2026-05-11) — docs 정합 + 자체 검수 + codex v1 + multi-worker + 옵션 B + codex v2 로 24건 해결 |
