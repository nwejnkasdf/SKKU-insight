...
- 다운로드 캐시 `.cache/cso/CSO.3.5.csv` (git-tracked `data/cso/CSO.3.5.csv` 를 `make seed-cso-cache` 로 카피, C-46 2026-05-24)
...
- **CSO version pin**: 1차는 CSO 3.5 (git-tracked `data/cso/CSO.3.5.csv`, CC BY 4.0 attribution `NOTICE.md`). `CSO_DOWNLOAD_URL` env로 다른 버전 fallback 가능 (decision-backlog P1-5).
